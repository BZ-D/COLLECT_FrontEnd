  ...
  <div class="all-tasks-page">
    ...
    <div style="display: flex; justify-content: center;">
      <el-row type="flex" id="release-btn" style="width: 66%; margin-top: 15px">
        <img src="../../../assets/image/plaza-green.png" alt="" style="width: 150px">
      </el-row>
    </div>
    ...
    <div class="list-box">
      ...
      >
        ...
        <el-table-column label="操作" width="130px">
          <template v-slot="scope">
            <el-button type="admin" @click="gotoDetail(scope.row.id)">任务详情</el-button>
          </template>
        </el-table-column>
      </el-table>
    </div>
...
export default {
  ...
  methods: {
    async getTaskList() {
      ...
      if (res.code === 404) {
        this.loading = false;
        return this.$message.info('未获取到已发布的任务');
      }
    ...
    gotoDetail(taskID) {
      this.$router.push(`/admin/detail/${taskID}`)
    }
  }
